...
insert into book (id, title, authors) values (4, 'Czwarta książka', 'Alex Dyszy');
insert into book (id, title, authors) values (5, 'Piąta książka', 'Mariusz Mariuszewski');
insert into book (id, title, authors) values (6, 'Szosta książka', 'Jan Ban');